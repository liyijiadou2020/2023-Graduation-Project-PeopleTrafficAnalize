...
import torch
# -------------------- bug: -------------------------
# from torch._six import container_abcs, string_classes, int_classes #TODO:BUG, seems that torch 2.0.0 do not support _six anymore
# -------------------- bug fix ----------------------
print("[INFO] torch verison: ", torch.__version__)
