...
def setup_cfg(args):
    ...
    cfg = get_cfg()
    cfg.merge_from_file(args.config_file) #TODO: BUG!
...
def get_parser():
    ...
    parser.add_argument(
        "--config-file",
        default="../configs/DukeMTMC/mgn_R50-ibn.ymal", # 20230401
        metavar="FILE",
...
if __name__ == '__main__':
    ...
    cfg = setup_cfg(args) #TODO: BUG! Linux系统中的logs/dukemtmc/mgn_R50-ibn/config.yaml 在这里找不到！
