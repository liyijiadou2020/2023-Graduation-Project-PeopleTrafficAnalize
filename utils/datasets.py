...
class LoadImages:  # for inference
    def __init__(self, path, img_size=640):
        ...
        self.files = images + videos # 所有文件列表
...
# 自适应图片缩放
"""
- letterbox的主要思想是尽可能地利用网络感受野的信息特征。
  在YOLOv5中，最后一层的特征图中每个点，可以对应原图中32X32的区域信息，
  在保证图片变换比例一致的情况下，长宽均可以被32整除，那么就可以有效的利用感受野的信息。
- 假设原图尺寸为(720, 640)，目标缩放尺寸为(640, 640)。
  要想满足收缩的要求，应该选取收缩比例720 ÷ \div÷ 640 = 0.88.
  则图片被缩放为(640,569),然后，要填充边界至可以被stride=32整除，则569填充至576，
  最终得到图片尺寸为(640, 576)。
"""
